...
- یه پروژه جدید تو ورسل می‌سازه (یا به پروژه قبلیت وصل میشه).
- متغیرهای محیطی (ENV) رو اتوماتیک روی سرور ست می‌کنه.
...
- `Redeploy current linked project`: دیپلوی مجدد روی همین پروژه.
- `Update production env vars`: آپدیت کردن متغیرها و سرعت‌ها.
- `List recent deployments`: دیدن لیست دیپلوی‌های اخیر.
...
| `MAX_UP_BPS` | ⚪ اختیاری | سقف سرعت آپلود (بایت بر ثانیه) | `4587520` |
| `MAX_DOWN_BPS` | ⚪ اختیاری | سقف سرعت دانلود (بایت بر ثانیه) | `4587520` |
